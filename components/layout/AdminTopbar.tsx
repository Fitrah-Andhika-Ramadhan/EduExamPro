      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            <p className="font-label-md text-label-md text-primary font-bold">Admin Institusi</p>
            <p className="text-[10px] text-on-surface-variant leading-none">Universitas Indonesia</p>
          </div>
          <div className="w-10 h-10 rounded-full overflow-hidden bg-primary-container">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img alt="Administrator Profile" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDlViOBIrbi7H6kB0GYR_fj3nZeQRJVNLVgzGiSUkl0Ro2D8mZHa2TMrfYPl_4QMorzFkbcj0bQCj9hjlGPOm5cDfdyA-_JbODXun_ihNEhpkDuLb-kJ0QxTx5oGgvbGrcM2V8AQ_AYKI3aO5LS8kCKt0MVmQyd1gtv_KstQEOQiWkDCxukAtSAuySf3I8XmYn814pqkkwzApQaET6NgpthMv2DJ5ulqiP8lHmT1Ggmr-u1IbU_QuEaWZ-wXQQ3t4G0Vi8H4xKOxc-H"/>
          </div>
        </div>
      </div>
    </header>
